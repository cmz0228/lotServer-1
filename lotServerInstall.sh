...
function Install()
{
  ...
  #wget --no-check-certificate -qO "${AcceTmp}/etc/apx.lic" "https://www.lotsever.tk/keygen.php?mac=${Mac}"
  wget --no-check-certificate -qO "${AcceTmp}/etc/apx.lic" "http://api.lotsever.tk:4000/regenspeeder/lic?bandWidth=10G&mac=${Mac}&expires=2999-12-31"
